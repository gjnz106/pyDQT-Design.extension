...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Quick Select Manager v2.1 - DQT"
    ...
    <Grid Margin="15">
        ...
        <!-- Header -->
        <Border Grid.Row="0" Background="#F0CC88" CornerRadius="6" Padding="15,12" Margin="0,0,0,12">
            <Grid>
                ...
                <StackPanel Grid.Column="0">
                    <TextBlock Text="🔍 Quick Select Manager" FontSize="20" FontWeight="Bold" Foreground="#333"/>
                    <TextBlock Text="Find, select, and navigate to any element in your model" FontSize="11" Foreground="#666" Margin="0,3,0,0"/>
                </StackPanel>
                <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
                    <TextBlock Text="Display:" FontSize="12" Foreground="#333" VerticalAlignment="Center" Margin="0,0,8,0"/>
                    <ComboBox x:Name="cmbDisplay" Width="140" Padding="8,5" SelectedIndex="0">
        ...
        <Grid Grid.Row="1" Margin="0,0,0,12">
            ...
            <Border Grid.Column="0" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="12,8" Margin="0,0,5,0">
                <StackPanel>
                    <TextBlock Text="TOTAL ELEMENTS" FontSize="9" Foreground="#666" FontWeight="SemiBold"/>
                    <TextBlock x:Name="txtTotal" Text="0" FontSize="24" FontWeight="Bold" Foreground="#333"/>
                </StackPanel>
            </Border>
            
            <Border Grid.Column="1" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="12,8" Margin="5,0">
                <StackPanel>
                    <TextBlock Text="CHECKED" FontSize="9" Foreground="#666" FontWeight="SemiBold"/>
                    <TextBlock x:Name="txtChecked" Text="0" FontSize="24" FontWeight="Bold" Foreground="#E5B85C"/>
                </StackPanel>
            </Border>
            
            <Border Grid.Column="2" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="12,8" Margin="5,0">
                <StackPanel>
                    <TextBlock Text="CATEGORIES" FontSize="9" Foreground="#666" FontWeight="SemiBold"/>
                    <TextBlock x:Name="txtCategories" Text="0" FontSize="24" FontWeight="Bold" Foreground="#4CAF50"/>
                </StackPanel>
            </Border>
            
            <Border Grid.Column="3" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="12,8" Margin="5,0,0,0">
                <StackPanel>
                    <TextBlock Text="FAMILIES" FontSize="9" Foreground="#666" FontWeight="SemiBold"/>
                    <TextBlock x:Name="txtFamilies" Text="0" FontSize="24" FontWeight="Bold" Foreground="#2196F3"/>
                </StackPanel>
            </Border>
        </Grid>
        ...
        <Grid Grid.Row="2">
            ...
            <!-- Left Panel - Filters -->
            <Border Grid.Column="0" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="10" Margin="0,0,10,0">
                <Grid>
                    <Grid.RowDefinitions>
                    ...
                    <!-- Search -->
                    <TextBlock Grid.Row="0" Text="SEARCH" FontSize="10" FontWeight="SemiBold" Foreground="#333" Margin="0,0,0,5"/>
                    <TextBox Grid.Row="1" x:Name="txtSearch" Padding="8,6" Margin="0,0,0,12" FontSize="12"/>
                    
                    <!-- Filter by Family/Type -->
                    <TextBlock Grid.Row="2" Text="FILTER BY" FontSize="10" FontWeight="SemiBold" Foreground="#333" Margin="0,0,0,5"/>
                    <ComboBox Grid.Row="3" x:Name="cmbFilter" Padding="8,5" Margin="0,0,0,12" SelectedIndex="0">
                        <ComboBoxItem Content="All Elements"/>
                        <ComboBoxItem Content="Model Elements"/>
                        <ComboBoxItem Content="Annotation"/>
                        <ComboBoxItem Content="MEP Elements"/>
                    ...
                    <Grid Grid.Row="4">
                        ...
                        <TextBlock Grid.Row="0" Text="CATEGORY" FontSize="10" FontWeight="SemiBold" Foreground="#333" Margin="0,0,0,5"/>
                        <ListBox Grid.Row="1" x:Name="lstCategories" 
                ...
                <DataGrid.Columns>
                    <DataGridTemplateColumn Header="☐" Width="40">
                        <DataGridTemplateColumn.CellTemplate>
                            <DataTemplate>
                                <CheckBox IsChecked="{Binding is_checked, Mode=TwoWay, UpdateSourceTrigger=PropertyChanged}" 
                                          HorizontalAlignment="Center" VerticalAlignment="Center"/>
                            </DataTemplate>
                        </DataGridTemplateColumn.CellTemplate>
                    </DataGridTemplateColumn>
                    <DataGridTextColumn Header="ID" Binding="{Binding element_id}" Width="75" IsReadOnly="True"/>
                    <DataGridTextColumn Header="Category" Binding="{Binding category}" Width="120" IsReadOnly="True"/>
                    <DataGridTextColumn Header="Family" Binding="{Binding family}" Width="150" IsReadOnly="True"/>
                    <DataGridTextColumn Header="Type" Binding="{Binding type_name}" Width="150" IsReadOnly="True"/>
                    <DataGridTextColumn Header="Name/Mark" Binding="{Binding name}" Width="*" MinWidth="100" IsReadOnly="True"/>
                    <DataGridTextColumn Header="Level" Binding="{Binding level}" Width="90" IsReadOnly="True"/>
                </DataGrid.Columns>
            </DataGrid>
        </Grid>
        
        <!-- Action Buttons -->
        <Border Grid.Row="3" Background="White" BorderBrush="#D4B87A" BorderThickness="1" CornerRadius="5" Padding="10" Margin="0,12,0,0">
            <Grid>
                <Grid.ColumnDefinitions>
                    <ColumnDefinition Width="Auto"/>
                    <ColumnDefinition Width="*"/>
                ...
                <StackPanel Grid.Column="0" Orientation="Horizontal">
                    <Button x:Name="btnCheckAll" Content="Check All" Style="{StaticResource BtnSecondary}"/>
                    <Button x:Name="btnCheckNone" Content="Uncheck All" Style="{StaticResource BtnSecondary}"/>
                    <Button x:Name="btnInvert" Content="Invert" Style="{StaticResource BtnSecondary}"/>
                </StackPanel>
                
                <!-- Center - Main actions -->
                <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Center">
                    <Button x:Name="btnZoom" Content="🔍 Zoom To" Style="{StaticResource BtnPrimary}"/>
                    <Button x:Name="btnSelect" Content="✓ Select in Model" Style="{StaticResource BtnPrimary}"/>
                    <Button x:Name="btnIsolate" Content="👁 Isolate" Style="{StaticResource BtnPrimary}"/>
                    <Button x:Name="btnShow" Content="📍 Show Element" Style="{StaticResource BtnPrimary}"/>
                </StackPanel>
                
                <!-- Right - Refresh -->
                <StackPanel Grid.Column="2" Orientation="Horizontal">
                    <Button x:Name="btnRefresh" Content="🔄 Refresh" Style="{StaticResource BtnSecondary}"/>
                    <Button x:Name="btnClose" Content="Close" Style="{StaticResource BtnSecondary}"/>
                </StackPanel>
            </Grid>
        </Border>
        ...
        <Grid Grid.Row="4" Margin="0,10,0,0">
            ...
            <TextBlock Grid.Column="0" Text="💡 Double-click to zoom | Shift+Click for range | Ctrl+Click for multi-select" 
                       FontSize="11" Foreground="#666" VerticalAlignment="Center"/>
            <TextBlock Grid.Column="1" Text="Copyright © 2025 Dang Quoc Truong - DQT" 
