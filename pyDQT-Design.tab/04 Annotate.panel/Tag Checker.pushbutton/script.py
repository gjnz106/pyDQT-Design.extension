...
<Window
                    ...
                    <ControlTemplate TargetType="Button">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                <Setter TargetName="bd" Property="Background" Value="#E5BF70"/>
                            </Trigger>
                            <Trigger Property="IsPressed" Value="True">
                                <Setter TargetName="bd" Property="Background" Value="#D4A94E"/>
                            </Trigger>
                            <Trigger Property="IsEnabled" Value="False">
                                <Setter TargetName="bd" Property="Background" Value="#E0D5C0"/>
                ...
                <Setter.Value>
                    <ControlTemplate TargetType="Button">
                        ...
                        <ControlTemplate.Triggers>
                            ...
                            <Trigger Property="IsEnabled" Value="False">
                                <Setter TargetName="bd" Property="Background" Value="#A5D6A7"/>
                                <Setter TargetName="bd" Property="Opacity" Value="0.6"/>
                            </Trigger>
                        </ControlTemplate.Triggers>
                    </ControlTemplate>
            ...
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="Button">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                <Setter TargetName="bd" Property="Background" Value="#EF5350"/>
                            </Trigger>
                            <Trigger Property="IsPressed" Value="True">
    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#F0CC88" Padding="16,12">
            <StackPanel>
                <TextBlock Text="TAG CHECKER"
                           FontSize="18" FontWeight="Bold"
                           Foreground="#333333"/>
                <TextBlock Text="Check and auto-tag untagged elements in current view"
                           FontSize="11" Foreground="#5D4E37" Margin="0,2,0,0"/>
            </StackPanel>
        </Border>
        ...
        <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto"
            ...
            <StackPanel>
                ...
                <Border Style="{StaticResource CardBorder}">
                    <StackPanel>
                        <TextBlock Text="Select Categories to Check"
                        ...
                        <Grid>
                            ...
                            <StackPanel Grid.Column="1" Orientation="Horizontal"
                                        Margin="8,0,0,0">
                                <Button x:Name="btnSelectAll" Content="All"
                                        FontSize="11" Padding="8,4"
                                        Background="#FFFFFF" BorderBrush="#D4B87A"
                        ...
                        <Border BorderBrush="#E0D5C0" BorderThickness="1"
                ...
                <Border Style="{StaticResource CardBorder}">
                    <StackPanel>
                        <TextBlock Text="Options"
                                   FontSize="13" FontWeight="SemiBold"
                                   Foreground="#5D4E37" Margin="0,0,0,8"/>
                        <CheckBox x:Name="cbIncludeLinks"
                                  Content="Include Linked Files"
                                  FontSize="12" IsChecked="True"
                                  Margin="0,0,0,6"/>
                        <StackPanel Orientation="Horizontal">
                            <TextBlock Text="Max Tag Distance (mm):"
                                       FontSize="12" VerticalAlignment="Center"
                                       Margin="0,0,8,0"/>
                            <TextBox x:Name="tbMaxDist" Text="3000"
                                     Width="80" Padding="4,3"
                                     FontSize="12" BorderBrush="#D4B87A"/>
                        </StackPanel>
                    </StackPanel>
                </Border>
                ...
                <StackPanel Orientation="Horizontal" Margin="0,4,0,4">
                    <Button x:Name="btnCheck" Content="Check Tags"
                            Style="{StaticResource GoldBtn}" Margin="0,0,8,0"/>
                    <Button x:Name="btnAutoTag" Content="Tag All Untagged"
                            Style="{StaticResource GreenBtn}" IsEnabled="False"
                            Margin="0,0,8,0"/>
                    <Button x:Name="btnSelect" Content="Select Untagged"
                            Style="{StaticResource GoldBtn}" IsEnabled="False"/>
                </StackPanel>
                <!-- BUTTONS ROW 2 -->
                ...
                <!-- RESULTS -->
                <Border x:Name="borderResults" Style="{StaticResource CardBorder}"
                        Visibility="Collapsed">
                    <StackPanel>
                        <TextBlock x:Name="tbSummary"
                                   FontSize="13" FontWeight="SemiBold"
                                   Foreground="#5D4E37" Margin="0,0,0,4"
                                   TextWrapping="Wrap"/>
                        <Grid Height="24" Margin="0,4,0,8">
                            <Border Background="#E0D5C0" CornerRadius="4"/>
                            <Border x:Name="borderProgress"
                                    Background="#6BBF59" CornerRadius="4"
                        ...
                        <StackPanel Orientation="Horizontal" Margin="0,0,0,4">
                            <Border Background="#DC3C3C" Width="14" Height="14"
                                    CornerRadius="2" Margin="0,0,4,0"/>
                            <TextBlock Text="Untagged" FontSize="11"
                                       VerticalAlignment="Center" Margin="0,0,12,0"/>
                            <Border Background="#FFA500" Width="14" Height="14"
                                    CornerRadius="2" Margin="0,0,4,0"/>
                            <TextBlock Text="Tag Too Far" FontSize="11"
                                       VerticalAlignment="Center" Margin="0,0,12,0"/>
                            <Border Background="#3CB44B" Width="14" Height="14"
                                    CornerRadius="2" Margin="0,0,4,0"/>
                            <TextBlock Text="New Auto-Tag" FontSize="11"
                                       VerticalAlignment="Center" Margin="0,0,12,0"/>
                            <Border Background="#9C27B0" Width="14" Height="14"
                                    CornerRadius="2" Margin="0,0,4,0"/>
                            <TextBlock Text="Tag with ?" FontSize="11"
                                       VerticalAlignment="Center"/>
                        </StackPanel>

                        <TextBlock FontSize="10" Foreground="#888888"
                                   FontStyle="Italic" Margin="0,0,0,4"
                                   Text="Double-click item to zoom (closes dialog temporarily)"/>

                        <TextBlock x:Name="tbTagResult" FontSize="12"
                                   Foreground="#2E7D32" TextWrapping="Wrap"
                                   Visibility="Collapsed" Margin="0,4,0,4"/>

                        <!-- Untagged -->
                        <TextBlock x:Name="tbUntaggedHeader" FontSize="12"
                                   FontWeight="SemiBold" Foreground="#DC3C3C"
                                   Visibility="Collapsed" Margin="0,4,0,2"/>
                        <ListBox x:Name="lbUntagged" MaxHeight="180"
                                 FontSize="11" BorderBrush="#E0D5C0"
                                 Visibility="Collapsed"
                                 ScrollViewer.VerticalScrollBarVisibility="Auto"/>

                        <!-- Far tags -->
                        <TextBlock x:Name="tbFarHeader" FontSize="12"
                                   FontWeight="SemiBold" Foreground="#FFA500"
                                   Visibility="Collapsed" Margin="0,8,0,2"/>
                        <ListBox x:Name="lbFarTags" MaxHeight="140"
                                 FontSize="11" BorderBrush="#E0D5C0"
                                 Visibility="Collapsed"
                                 ScrollViewer.VerticalScrollBarVisibility="Auto"/>

                        <!-- Question mark tags -->
                        <TextBlock x:Name="tbQuestionHeader" FontSize="12"
                                   FontWeight="SemiBold" Foreground="#9C27B0"
                                   Visibility="Collapsed" Margin="0,8,0,2"/>
                        <ListBox x:Name="lbQuestionTags" MaxHeight="140"
                                 FontSize="11" BorderBrush="#E0D5C0"
                                 Visibility="Collapsed"
                                 ScrollViewer.VerticalScrollBarVisibility="Auto"/>
                    </StackPanel>
        ...
        <!-- FOOTER -->
        <Border Grid.Row="2" Background="#F0CC88" Padding="12,8">
            <TextBlock Text="Copyright by Dang Quoc Truong - DQT (c) 2026"
                       FontSize="10" Foreground="#5D4E37"
                       HorizontalAlignment="Center"/>
        </Border>
    </Grid>
</Window>
...
class TagCheckerWindow(object):
    ...
    def _show_results(self):
        ...
        if pct >= 90:
            ...
            self.borderProgress.Background = bc.ConvertFromString("#F0CC88")
        else:
